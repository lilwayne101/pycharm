...
# torch.Size([60000, 28, 28])   NV结构
# print(train_dataset.data.shape)
# torch.Size([10000, 28, 28])   NV结构
...
class Trainer:
    def __init__(self):
        ...
        self.train_loader = torch.utils.data.DataLoader(dataset=self.train_dataset, batch_size=3000, shuffle=True)
        self.test_dataset = MnistDataset(root, is_train=False)
        self.test_loader = torch.utils.data.DataLoader(dataset=self.test_dataset, batch_size=3000, shuffle=True)
